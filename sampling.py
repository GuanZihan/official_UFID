...
from caption_dataset import DatasetLoader, CaptionBackdoor, Backdoor
...
def arg_parse() -> SamplingConfig:
    ...
    os.environ.setdefault("CUDA_VISIBLE_DEVICES", configure.gpu)
...
if __name__ == '__main__':
    ...
    print(configure.output_dir)
    accelerator: Accelerator = Accelerator(log_with=["tensorboard", "wandb"], project_dir=os.path.join(configure.output_dir, "logs"))
