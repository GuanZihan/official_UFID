...
class SamplingStatic:
    ...
    IMAGE_NUM_PER_PROMPT: int = 5
    IMAGE_NUM_PER_GRID_SAMPLE: int = 4 # control how many samples 
    FORMAT: str = "png"
...
class MeasuringStatic:
    ...
    IMAGE_NUM_PER_PROMPT: int = 5
    IMAGE_NUM_PER_GRID_SAMPLE: int = 5 # modified: 9
    DEFAULT_SAMPLE_PROMPTS_N: int = 100
